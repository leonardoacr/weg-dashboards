...
import { statusGraphData } from "@/data/statusGraph";
...
const GraphsDashboards = () => {
  ...
  return (
    <div className="grid w-full grid-cols-2  gap-3 px-6 text-black sm:grid-cols-1 md:grid-cols-2">
      ...
      <div className={`${chartHeight} w-full bg-white  px-6 pt-6`}>
        <div>
          <h2 className="font-bold text-label-color ">Histórico do Status</h2>
          <div className="flex">
            {/* <Graphs
              graphData={[
                {
